...
import com.updev.newsapp.Models.NewsApiResponse;
...
public class RequestManager {
    ...
    public void getNewsHeadlines(OnFetchDataListner listner,String category, String query)
    {
        ...
        Call<NewsApiResponse> call = callNewsApi.callHeadlines("in","technology",query, context.getString(R.string.api_key));
